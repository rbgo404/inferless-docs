...
1. Enabling Auto-build while importing the model  
   ...
   3.  In the 4th step, “Configure model”, the webhook url is visible upon checking the “Setup automatic build” box
...
3.  In the model page, go to the “Automatic Build” tab, webhook url is visible upon checking the “Setup automatic build” box
