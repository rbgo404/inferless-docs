...
<Frame caption = "Profile Settings">![](/images/my-secret1.png)</Frame>

Select "My Secrets"

<Frame caption = "My Secrets">![](/images/my-secret2.png)</Frame>


### Create a secret 

<Frame caption = "Manage Secrets">![](/images/my-secret3.png)</Frame>


Enter the key and Values 

<Frame caption = "Manage Secrets">![](/images/my-secret4.png)</Frame>
...
<Frame caption = "Model Import"> ![](/images/my-secret6.png)</Frame>
...
<Frame caption="Model Settings">![](/images/my-secret7.png)</Frame>
