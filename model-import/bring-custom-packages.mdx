...
Youn you edit the runtime in UI or patch the runtime using CLI to create a new version of the runtime. All your model will remain in the version you previoulsy deployed unless you explicitely update in Model Settings. You can see all the versions of the runtime by clicking '...' button and seleting 'Runtime Version'

![](/images/bring-custom6.png)

You can look at the packages in the version bu clicking on "View Packages"

![](/images/bring-custom7.png)

To update the Runtime of a model you can go to the Model Card and naviage to Settings Page and select the version of the runtime you want to deploy and click on update. 
