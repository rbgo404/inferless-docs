...
inferless init
```
2. Upload [Custom Runtime](https://github.com/inferless/Logo-Generator/blob/main/inferless-runtime-config.yaml): Use the following command to upload your custom runtime.
```bash
...
Here are a few examples of logos from our application:
