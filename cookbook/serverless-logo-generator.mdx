...
Please note that we have utilized the A100 machine for model benchmarking purposes, while for pricing comparison, we referenced the A10G price from both platforms. This is due to the unavailability of the A100 GPU in SageMaker.
