---
title: "Build a Google Maps Agent using MCP & Ollama"
description: "In this tutorial, you’ll build a serverless conversational agent that
leverages Google Maps data via the Model Context Protocol (MCP) and a local Ollama LLM server.
You’ll learn how to manage the Ollama server, integrate MCP Google Maps tools, and
craft prompts that turn raw place data into concise, user-friendly responses."
---
...
<video width="640" height="360" controls>
  <source src="/videos/mcp-google-agent-demo.mp4" type="video/mp4"/>
</video>
