...
- __Inference Time:__ All models are hypothetically deployed on A100 80GB, taking 650.51 seconds to process an average PDF size of 18-20 pages and a cold start overhead of 57.94 seconds.<br />
...
Processing 100 queries and each takes 650.51 seconds<br/>
Total: 100 x 650.51 = 65051 seconds (or approximately 18.07 hours)
2. __Idle Timeout Duration:__<br/>
Post-processing idle time before scaling down: (700 seconds - 650.51 seconds) x 100 = 4949 seconds (or 1.37 hours approximately)<br/>
3. __Cold Start Overhead:__<br/>
Total: 100 x 57.94 = 5794 seconds (or 1.61 hours approximately)<br/>

__Total Billable Hours with Inferless:__ 18.07 (inference duration) + 1.37 (idle time) + 1.61 (cold start overhead)  = 21.05 hours<br/>
__Total Billable Hours with Inferless:__ 21.05 hours<br/>

| Scenario | On-Demand Cost | Serverless Cost|
| :--- | :---- | :---- |
|  100 requests/day | \$28.8 (24 hours billed at $1.22/hour) | \$25.68 (21.05 hours billed at $1.22/hour) |
