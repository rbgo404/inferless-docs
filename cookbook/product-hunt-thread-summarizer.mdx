...
- **Action:**  
  ...
  2. Clean and preprocess the text by splitting it into logical chunks, filtering out unrelated lines (e.g., “Upvote”, “Share”), and capturing key metadata such as timestamps and authors.  
