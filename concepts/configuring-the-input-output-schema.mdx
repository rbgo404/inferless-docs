...
Inferless allows you to easily define input and output schemas for APIs following the **Inference Protocol v2**. You can now define your inputs and outputs directly within your code using Pydantic models, or, for backward compatibility, you can still use an `input_schema.py` file. This document explains both methods.

---

## Input Schema (New Way)
...
### Input Schema ( Old Way with input_schema.py )
...
### Output Schema ( Old Way with dict return )
