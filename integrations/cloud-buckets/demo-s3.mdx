...
* Since we are using a model from AWS S3 in this example, select `File `as the method of uploading.
...
* This would open a new tab with `"My Integrations"`. You can click `Connect Account` on the necessary accounts there.
