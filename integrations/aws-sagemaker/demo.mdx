...
## Pre Requisite: Note the ARN details from AWS Sagemaker

* You would need to note down the ARN details from Sagemaker. A sample of how a ARN looks like is like -> `arn:aws:sagemaker:us-east-1:679004966033:model-package/gpt-neo`

### Steps to import model file from AWS Sage maker
...
* Since we are using a model from AWS Sagemaker in this example, select `File `as the method of upload.

* To proceed with the upload, you will need to connect your `AWS Sagemaker account`. This is a mandatory step as this helps us in downloading the file from your Sagemaker account.

<Frame caption = "Select Model Repository -> AWS Sagemaker.">![](/images/s3-3.png)</Frame>
...
<Frame caption = "Click Connect account under AWS Sagemaker">![](/images/s3-5.png)</Frame>
