...
* Make sure that the model file is stored in a .zip format and has the file structure as mentioned [here](https://app.gitbook.com/o/n3Et76kSUOGbJXGsk4wi/s/vFXaxgxbIieOFV5LLzNe/~/changes/7/deployment/importing-you-model-file/upload-model-file-system-cloud)
...
<Frame caption = "Add Model">![](/images/import-sys1.png)</Frame>
...
<Frame caption = "Choose the training framework used for your model">![](/images/import-sys2.png)</Frame>


###  Step 2: Choose the source of your model.

* Since we are importing a model from the system, in this example, select `File `as the method of upload.

* Select Local file in under `"Where do you have your file"?`

* Check the documentation once to make sure the file is in the right format.

![](/images/import-sys3.png)
...
<Frame caption = "Change Image above (WIP)">![](/images/import-sys6.png)</Frame>
...
<Frame caption = "Under the API Tab, you can view the API endpoint details.">![](/images/import-sys8.png)</Frame>
