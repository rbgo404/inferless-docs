...
![](/images/github-demo2.png)

###  Step 2: Choose the source of your model.

* Since we are using a model from Github, select `Repo(Custom Code)`as the method of upload.
...
<Frame caption = "After you have selected Repo ">![](/images/github-demo3.png)</Frame>


![](/images/github-demo4.png)
