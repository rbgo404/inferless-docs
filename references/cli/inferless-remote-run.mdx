...
### Getting Started Let's assume you have an app.py with 2 functions init and load 
...
You need to 4 lines of code to your app.py to make it run with remote run by initialising the inferless cls and adding functional annotations 
