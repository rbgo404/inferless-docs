...
This doc helps you configure the input / outputs of the 'infer' function in the 
You have to define the **input\_schema.py** in your GitHub/Gitlab repository this will help us create the Input parameters : 

For each input, there are 3 fields required and 1 optional field:s
...
For inputs that can take a variable number of values, you can set the `shape` field to `[-1]`. This indicates that the length of the array is not fixed and can vary.
