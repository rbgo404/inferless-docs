...
```bash
inferless remote-run app.py -c inferless-runtime-config.yaml --prompt "a living room, bright modern Scandinavian style house, large windows, magazine photoshoot, 8k, studio lighting"  --negative_prompt "low quality" --inference_steps "28" --guidance_scale "7.0"
```
