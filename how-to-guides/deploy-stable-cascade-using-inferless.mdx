...
We have deployed this model using A100 GPU and observed that the model took an average cold start time of `9.64sec` and an average inference time of `3.015sec` for image generation.
