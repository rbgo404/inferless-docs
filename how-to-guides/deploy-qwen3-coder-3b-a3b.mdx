...
description: "A 30.5 B-parameter Mixture-of-Experts coding LLM with only 3.3B active weights per token, 256 K-token native context and agentic tool-calling, delivering fast, long-context code generation."
---
