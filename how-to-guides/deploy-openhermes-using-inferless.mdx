---
title: "Deploy OpenHermes using Inferless"
description: "OpenHermes 2.5 Mistral 7B is a state-of-the-art Mistral Fine-tune, a continuation of the OpenHermes 2 model, which is trained on additional code datasets."
---
